...
const MODULE_HIERARCHY: { key: ModuleKey; sub?: ModuleKey[] }[] = [
  ...
  { key: 'usersV2', sub: ['usersV2_edit', 'usersV2_phone_view', 'usersV2_export'] },
  { key: 'ordersV3', sub: ['ordersV3_export', 'ordersV3_detail'] },
  { key: 'salesV3', sub: ['salesV3_claim', 'salesV3_dial', 'salesV3_update', 'salesV3_reassign', 'salesV3_config', 'salesV3_import_leads', 'salesV3_user_detail'] },
