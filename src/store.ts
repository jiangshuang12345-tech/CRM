...
const KEY = 'dinoai_crm_state_v25'
...
function seed(): AppState {
  ...
  const students: Student[] = [
    ...
    },
    {
      ...
      birthday: '2017-01-20', ageGroup: '6-8', loginMethod: '手机号', account: '+84 90-123-4567', phone: '+84 90-123-4567', businessLine: '越南', registerChannel: 'KOL / TikTok',
